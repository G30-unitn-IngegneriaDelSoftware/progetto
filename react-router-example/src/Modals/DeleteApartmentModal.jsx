...
function DeleteModal({ isOpen, onClose,value}) {
  ...
  function EliminazioneAppartamento() {

    axios
    .delete("http://localhost:3002/apartments/"+value)
    .then((response) => {
        ...
        >
          ...
          >
            <Typography variant="h6" color="white" sx={{ fontWeight: "bold", textAlign: "center" ,marginBottom: "1%" }}>
              Sei sicuro di voler eliminare l'appartamento con id:
            </Typography>
            <Typography variant="h6" color="white"sx={{ fontWeight: "bold", textAlign: "center" ,marginBottom: "2%" }}>
              {value}
            </Typography>
